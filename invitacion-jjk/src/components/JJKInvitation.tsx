...
export default function JJKInvitation() {
  ...
  if (hasRejected) {
    return (
      <div className="h-screen w-full bg-gradient-to-br from-red-950 via-slate-900 to-black flex flex-col items-center justify-center p-4 relative overflow-hidden">
        {/* Audio element */}
        ...
        <button
          onClick={handleBack}
          className="mt-6 inline-flex items-center gap-2 bg-gradient-to-r from-red-600 to-slate-600 hover:from-red-500 hover:to-slate-500 text-white font-bold py-3 px-6 rounded-full shadow-2xl shadow-red-500/30 transform hover:scale-105 transition-all duration-300 border-2 border-red-400/50"
        >
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-black flex flex-col items-center justify-center p-4 relative">
        ...
        <div className="max-w-md w-full bg-gradient-to-br from-blue-900/40 to-slate-900/40 backdrop-blur-xl rounded-3xl p-8 border border-cyan-500/20 shadow-2xl">
          <div className="text-center space-y-6">
            ...
            <p className="text-sm text-slate-300">Ya compré palomitas 🍿</p>
          </div>
        </div>
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-4 lg:p-6">
            ...
            <div className="space-y-4 lg:space-y-10">
              <div className="flex items-center gap-3 text-slate-200 bg-slate-950/50 p-3 lg:p-6 rounded-xl border border-cyan-500/10 hover:border-cyan-500/30 transition-colors">
                ...
                <div>
                  ...
                  <p className="font-semibold text-white text-sm lg:text-2xl">
                    Jueves 20 Noviembre
                  </p>
                </div>
              </div>
        ...
        <div className="w-full max-w-5xl flex flex-col items-center mt-4 lg:mt-6 gap-3">
          <button
            ...
            disabled={isLoading}
            className={`w-full max-w-sm lg:max-w-md bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold py-3 lg:py-3.5 px-8 rounded-full shadow-2xl shadow-cyan-500/30 transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3 border-2 border-cyan-400/50 ${
          ...
          <button
            ...
            disabled={isLoading}
            className={`w-full max-w-xs lg:max-w-sm bg-gradient-to-r from-red-600/80 to-slate-600/80 hover:from-red-500 hover:to-slate-500 text-white font-semibold py-2.5 lg:py-3 px-6 rounded-full shadow-xl shadow-red-500/20 transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 border border-red-400/30 ${
              isLoading ? "opacity-60 pointer-events-none" : ""
            }`}
          >
